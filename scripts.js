...
function clearCierre() {
    if (confirm("¿Estás seguro de que deseas limpiar el cierre de caja?")) {
        ...
        localStorage.removeItem("cierreData");
        ...
        document.getElementById("total-product-sales").innerText = 0;

        // Vaciar la tabla de cierre de caja
